...
def bootstrap_css():
    ...
    **Example**::
    ...
    return mark_safe("".join(list(rendered_urls)))
...
def bootstrap_javascript(jquery=False):
    ...
    **Example**::
    ...
    if jquery := jquery or get_bootstrap_setting("include_jquery", False):
        javascript_tags.append(bootstrap_jquery(jquery=jquery))

    if bootstrap_js_url := bootstrap_javascript_url():
...
class ButtonsNode(template.Node):
    ...
    def render(self, context):
        ...
        buttons = []
        submit = output_kwargs.get("submit")
        reset = output_kwargs.get("reset")
        if submit:
        ...
        output_kwargs |= {"label": None, "field": buttons}
